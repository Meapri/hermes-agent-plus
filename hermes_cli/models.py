...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("google-antigravity", "Google Antigravity (OAuth)", "Google Antigravity (Gemini/Claude/GPT via agy CLI OAuth)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "google":   ("Google Gemini",   "AI Studio API or OAuth + Code Assist",            ["gemini", "google-gemini-cli", "google-antigravity"]),
