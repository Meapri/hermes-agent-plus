...
ANTIGRAVITY_GOOGLE_GROUNDING_HINT = (
    ...
    "This applies to facts stated in the conversation history or injected "
    "context too: another user's past message or question may carry a FALSE "
    "premise (e.g. calling a president a 'lawmaker'). Never adopt a "
    "time-sensitive claim from the prompt context as truth — verify it with "
    "google_search first. "
