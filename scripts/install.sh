...
# Configuration
REPO_URL_SSH="git@github.com:Meapri/hermes-agent-plus.git"
REPO_URL_HTTPS="https://github.com/Meapri/hermes-agent-plus.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/Meapri/hermes-agent-plus/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
