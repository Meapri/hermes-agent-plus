...
$RepoUrlSsh = "git@github.com:Meapri/hermes-agent-plus.git"
$RepoUrlHttps = "https://github.com/Meapri/hermes-agent-plus.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Meapri/hermes-agent-plus/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Meapri/hermes-agent-plus/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Meapri/hermes-agent-plus/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Meapri/hermes-agent-plus/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
